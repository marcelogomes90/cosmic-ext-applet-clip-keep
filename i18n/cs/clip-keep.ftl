...
setting-image-size = Velikost obrázků
setting-image-size-small = Malé
setting-image-size-medium = Střední
setting-image-size-large = Velké
setting-paste-on-use = Vkládat automaticky
