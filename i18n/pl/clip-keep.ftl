...
clear-title = Wyczyścić historię?
clear-detail = Przypięte wpisy zostaną zachowane.
...
details-formats = Formaty
format-plain = Zwykły tekst
format-files = Pliki
...
setting-image-size = Rozmiar obrazów
setting-image-size-small = Mały
setting-image-size-medium = Średni
setting-image-size-large = Duży
